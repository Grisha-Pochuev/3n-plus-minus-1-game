...
| Поле | Значение |
|---|---|
| DOI | `No` — если у статьи ещё нет DOI |
...
Zenodo позволяет зарезервировать DOI в черновике. Это необязательно, но если
хотите напечатать DOI внутри PDF, сначала нажмите `Get a DOI now`, внесите DOI
в `paper/main.tex`, пересоберите пакет и повторно проверьте контрольные суммы.
...
После публикации добавьте полученный DOI в `README.md`, `CITATION.cff`,
`.zenodo.json`, `paper/main.tex` и библиографическую запись следующей версии.
